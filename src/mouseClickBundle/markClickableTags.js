...
const id = "mtrif.mouseclick.clickabletags";
let initContext;
...
function initCommonUI() {
    ...
    createRoot(box).render(CommonUIBox({ctx: initContext, activeStore, objectManager, tagTitle: 'Mark Clickable'}));
    return box;
}
...
function updater(virtualElement) {
    ...
    if (enabled) {
        obj.classList.add('__markedAsClickable');
    } else {
        obj.classList.remove('__markedAsClickable');
    }
}
